...
const step3 = `We do the rest! We will have it freshly pressed and returned by the selected time at the same location. You will be updated via text each step of the way!`;
